...
$(document).ready(function(){
  ...
  $('#facebook').on("click", function() {
    sharefb('http://mabu.newscloud.sbs.co.kr/electionquiz/index.html');
  });

  $('#twitter').on("click", function() {
    sharetwit('http://mabu.newscloud.sbs.co.kr/electionquiz/index.html', 'SBS마부작침: ');
  });
});
...
function sendLink() {
  Kakao.Link.sendDefault({
      objectType: 'feed',
      content: {
        title: '[2020총선] 모여봐요 비례의 숲',
        description: '내 이상형 후보, 넌 어딨니? 테스트를 통해 알아보자!',
        imageUrl: 'https://s3.ap-northeast-2.amazonaws.com/mabu.newscloud.sbs.co.kr/electionquiz/img/thumb2.jpg',
        link: {
          mobileWebUrl: 'http://mabu.newscloud.sbs.co.kr/electionquiz/index.html',
          webUrl: 'http://mabu.newscloud.sbs.co.kr/electionquiz/index.html'
        }
      },
      buttons: [
        {
...
creditButton.addEventListener('click', Credit)
...
function Credit() {
  ...
  rBox.style.backgroundColor = '#D1C4E9'
  resultContainer.appendChild(rBox)

  const rImg = document.createElement("img")
  rImg.classList.add('credit-img')
  rImg.src = './img/kk.png'
  rBox.appendChild(rImg)

  const rTitle = document.createElement("h1")
  rTitle.classList.add('r-title')
  rTitle.innerHTML = '우리는 마부작침'
  rBox.appendChild(rTitle)

  const rParag = document.createElement("p")
  rParag.innerHTML = "<모여봐요 비례의 숲>을 만든 사람들은 심영구, 정혜경, 배여운, 안준석, 안혜민, 김민아, 이승우, 이유민 총 8명입니다. 모두 마부작침 팀원들이네요!  자매품 <모여봐요! 국회의 숲> 도 얼마전에 오픈했어요.<br><br> <a href = 'http://mabu.newscloud.sbs.co.kr/2020election/'>국회의 숲 보러가기</a>"
  rParag.classList.add('credit-p')
  rBox.appendChild(rParag)

  const rImg2 = document.createElement("img")
  rImg2.classList.add('credit-img')
  rImg2.src = './img/bb.png'
  rBox.appendChild(rImg2)

  const rParag2 = document.createElement("p")
  rParag2.innerHTML = " <a href = 'https://news.sbs.co.kr/news/newsPlusList.do?themeId=10000000114&plink=BRAND&cooper=SBSNEWSMAIN'>SBS 데이터저널리즘팀 마부작침</a>은 <모여봐요 비례의 숲> 뿐만아니라 <a href = 'http://news.sbs.co.kr/news/mabuMain.do'><마부뉴스> 등</a> 다양한 콘텐츠를 제작하고 있습니다. <br> <br> 문의는 sbsdjmb@gmail.com "
  rParag2.classList.add('credit-p')
  rBox.appendChild(rParag2)

  const rButton = document.createElement("button")
  rButton.innerText = "처음으로 돌아가기"
...
function initQuestion(questions)
{
    ...
    qTitle.innerHTML = questions.quesiton
...
const questions = [
  ...
  {
    //1 - 보수 1차 질문
    quesiton: '지금 가장 중요한 이슈는?',
    image: './img/questions/03.jpg',
    answer: [
      { text: '중요한건 시장경제 회복!', value: 4 },
      { text: '자유민주주의가 최우선', value: 5 },
      { text: '기초소득을 국민에게 줘야해', value: 100 },
      { text: '아닌데? 다른 이슈가 중요해', value: 6 }
    ]
  },
  {
    //2 - 짬뽕 1차 질문
    quesiton: '정당이면 후보자<br>두 자릿수는 돼야지',
  ...
  {
    //4     2차 질문
    quesiton: '경제 정책 뭘 손봐야할까?',
    image: './img/questions/06.jpg',
    answer: [
      { text: '최저임금 재조정이 필요해', value: 11},
      { text: '비정규직의 정규직화', value: 12 }
    ]
  },
  {
    //5
    quesiton: '박근혜 전 대통령 탄핵<br>어떻게 생각해?',
  ...
  {
    //7 허경영 저격질문
    quesiton: '코로나 긴급지원금<br>1억원씩 줘야 해!',
    image: './img/questions/09.jpg',
    answer: [
      { text: '100만원도 시끄러운데 가능해?', value: 14 },
      { text: '힘든데 1억씩은 줘야지', value: 200 }
    ]
  },
  {
    //8
    quesiton: '그러려면 정당 후보가<br>두 자릿수는 돼야지!',
    image: './img/questions/04.jpg',
    answer: [
      { text: '맞아! 그래야 추진력이 생기지', value: 15 },
      { text: '아냐, 후보자 수는 상관없어!', value: 107 }
    ]
  },
  {
    //9
    ...
    answer: [
      ...
      { text: '우선 석탄부터 재생에너지로!', value: 17 }
    ]
  },
  {
    //10    3차 질문
    quesiton: '청와대에도 있어봐야<br>국정을 알지',
    image: './img/questions/12.jpg',
    answer: [
      { text: '맞아! 그건 그렇겠네', value: 108 },
      { text: '방송경험 있으면 되지', value: 109 },
      { text: '능력만 있으면 돼!', value: 18 }
    ]
  },
  {
    //11 //////////////////////////////////////////////////////////////////////////여기부터 다시
    ...
    answer: [
      { text: '연륜있는 60대 이상이 잘하지', value: 19 },
  ...
  {
    //14
    quesiton: '코로나19에 필요한 대책은?',
    image: './img/questions/16.jpg',
    answer: [
      { text: '질본을 질병통제청으로 확대', value: 21 },
      { text: '자영업자부터 살려야 해!', value: 22 }
    ]
  },
  {
    //15
    quesiton: '아무래도 전과는<br>없어야겠지?',
    image: './img/questions/17.jpg',
    answer: [
      { text: '모든 전과가 문제는 아냐', value: 203 },
      { text: '전과 없는 사람들이 제격이지', value: 23 }
    ]
  },
  {
    //16
    quesiton: '탈핵하려면 어떤 사람이<br>잘 할것 같아?',
    image: './img/questions/18.jpg',
    answer: [
      { text: '마더 가이아! 여성이 제격!', value: 205 },
  ...
  },
  {
    ...
    image: './img/questions/17.jpg',
    answer: [
      { text: '전과 없는 사람들이 제격이지', value: 25 },
      { text: '모든 전과가 문제는 아냐', value: 209 }
    ]
  },
  {
    //19
    ...
    image: './img/questions/20.jpg',
    answer: [
      { text: '공직 경험이 필요해', value: 210 },
      { text: '애국선열의 뜻을 계승해야지', value: 211 }
    ]
  },
  {
    //20
    ...
    image: './img/questions/20.jpg',
    answer: [
      { text: '언론인과 홍보전문가가 좋겠어', value: 212 },
      { text: '리더의 경험이 필요해', value: 213 },
  ...
  },
  {
    ...
    answer: [
      ...
      { text: '연륜있는 40대 이상!', value: 26 }
    ]
  },
  {
    //22
    quesiton: '자영업자 부양책<br>누가 잘 할까?',
    image: './img/questions/21.jpg',
    answer: [
      { text: '알바 경험 많은 20대가 필요해', value: 114 },
      { text: '사회생활 좀 해본 30~50대', value: 217 },
  ...
  },
  {
    ...
    image: './img/questions/21.jpg',
    answer: [
      { text: '성감수성 민감한 2030이 좋아', value: 27 },
  ...
  },
  {
    ...
    image: './img/questions/20.jpg',
    answer: [
      { text: '세상을 향해 소리내는 여성', value: 224 },
      { text: '세상을 향해 소리내는 남성', value: 120 },
      { text: '세상을 향해 소리내는 퀴어', value: 121 }
    ]
  },
  {
    //29
    quesiton: '어떤 경험이<br>국회 활동에 도움될까?',
...
},
{
  ...
  color: '#9366CC',
  survive: 0 ,
  text: "당신의 이상형은 이지원, 이경옥, 박보람, 김주희 후보입니다. 모두 <strong>여성의당</strong> 소속이네요!<br><br> 당신은 진보 성향, 여성의 안전이 가장 중요하고 소수 정당 소속 후보를 이상형으로 선택했어요.<br><br><a href ='https://www.notion.so/sbsdata/29-e39bf1bd84a34a96b4be09b65621e655'>여성의당 정책보기</a>"
},
{
  //108번 열린민주당 엔딩1
  title: "문의 남자",
...
},
{
  ...
  color: '#F4809E',
  survive: 0 ,
  text: "당신의 이상형은 탈북 인권운동가 지성호, 체육계 미투 1호 김은희, 장애 피아니스트 김예지 후보를 포함해 박대성, 김보람 후보 등 5명입니다. 모두<strong>미래한국당</strong>입니다.<br><br> 당신은 보수 성향, 시장경제의 회복이 가장 중요하고 최저임금 재조정을 우선 추진하며 20대 30대인 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/4-68de39a6e59c4cad82a76eaee080c04f'>미래한국당 정책보기</a>"
},
{
  //111번 한국경제당 엔딩1
  title: "겐세이 요정",
  ...
  color: '#7d7d8d',
  survive: 0 ,
  text: "당신의 이상형은 '사퇴하세요'로 유명한 이은재, 최다 전과(18)인 최종호 후보를 포함해 방형린, 천은미, 전진영, 박원희 후보 등 6명이에요. <strong>한국경제당</strong> 후보들이네요.<br><br> 당신은 보수 성향, 시장경제의 회복이 가장 중요하고 비정규직의 정규직화를 우선 추진하며 중소정당 소속 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/9-a9e596a28af4433d827ce1fed402f09b'>한국경제당 정책보기</a>"
},
{
  //112번 
  title: "당신의 이상형은" +"\n"+ "존재하지 않습니다.",
...
},
{
  //202 우리공화당/친박신당 엔딩2
  title: "친박연대의 후예",
  image: './img/results/results-15.png',
  color: 'white',
  survive: 0 ,
  text: "당신의 이상형은 서청원, 인지연, 홍문종, 장정은 후보예요. <strong>우리공화당</strong>과 <strong>친박신당</strong> 후보들이네요.<br><br> 당신은 보수 성향, 자유민주주의가 최우선이고 박근혜 전 대통령 탄핵은 무효이며 정당 대변인 경험이 있는 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/7-480bae30533740bb83db11dbe593d0b1'>우리공화당 정책보기</a><br><a href = 'https://www.notion.so/sbsdata/11-442192000dfc4a68a491555b617c8352'>친박신당 정책보기</a>"
},
{
  //203 더불어시민당 엔딩1
  title: "지구는 달의 위성",
  ...
  color: '#328BC9',
  survive: 0 ,
  text: "당신의 이상형은 DJ 3남 김홍걸, 전 여성정책연구원장 권인숙, 민주당 영입 1호 최혜영 후보를 포함해 이동주, 양원영, 양경숙, 정우식, 최회용 후보 등 8명이랍니다 모두 <strong>더불어시민당</strong> 후보네요:)<br><br> 당신은 진보 성향, 여성의 안전이 가장 중요하고 후보자 10명 이상의 정당에 속한 전과가 있는 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/5-2f0321f246824b4fb5c57006b2113234'>더불어시민당 정책보기</a>"
},
{
  //204 녹색당 엔딩
...
},
{
  ...
  color: '#91D57C',
  survive: 0 ,
  text: "당신의 이상형은 제주도지사 후보자였던 고은영 후보를 포함해 김혜미, 성지수, 최정분 후보 등 4명이에요. 모두 <strong>녹색당</strong> 소속이네요.<br><br> 당신은 진보 성향, 환경이 가장 중요하고 탈핵을 우선 추진하는 여성 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/22-b6796bff769146b8b2d6ef3c980f6c3e'>녹색당 정책보기</a>"
},
{
  //206
  title: "대★리☆랭★크",
...
},
{
  ...
  color: '#658FCB',
  survive: 0 ,
  text: "당신의 이상형은 '도곡동 문건'의 주인공 전 대구국세청장 안원구 후보를 포함해 강민정, 한지양, 김성회, 국령애 후보 등 5명입니다. 모두 <strong>열린민주당</strong>인데 집시법, 국가보안법, 뇌물수수, 음주운전 전과 등이 있군요!<br><br> 당신은 진보 성향, 국회 개혁이 가장 중요하고 청와대 경력, 방송 경력 없는 전과 있는 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/12-1557779c7f624ba7bf605645a23c169d'>열린민주당 정책보기</a>"
},
{
  //210
  title: "고위 공무원",
...
},
{
  ...
  color: '#EF7D3F',
  survive: 0 ,
  text: "당신의 이상형은 김근태, 김예림, 정광호, 신나리, 장윤섭 후보 등 5명이에요. 모두 <strong>국민의당</strong> 소속이에요.<br><br> 당신은 진보도 보수도 아닌 성향, 비례후보 10명 이상이고 코로나 긴급지원금 1억 원씩 주는 건 불가능하며 코로나 시국에 질병관리본부를 질병관리청으로 확대 개편하자는 20대, 30대 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/10-7c6de5e18f2f4de8aeb1e78c0f9946af'>국민의당 정책보기</a>"
},
{
  //216
  title: "만덕산의 그늘",
  ...
  color: '#3CBF82',
  survive: 0 ,
  text: "당신의 이상형은 민생당 상임선대위원장 손학규, 현역 의원인 최도자, 장정숙 후보를 포함해 김종구, 이관승, 황한웅, 이봉원 후보 등 7명이에요. 모두 <strong>민생당</strong> 소속이네요.<br><br> 당신은 진보도 보수도 아닌 성향, 비례후보 10명 이상이고 코로나 긴급지원금 1억 원씩 주는 건 불가능하며 코로나 시국에 자영업자부터 지원해야 한다는 60대 이상 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/3-10-01b0120b1000454f891830abc2a5f913'>민생당 정책보기</a>"
},
{
  //217
  title: "민생은 맡겨라",
  ...
  color: '#3CBF82',
  survive: 0 ,
  text: "당신의 이상형은 민생당 대표 김정화 후보를 포함해 정혜선, 이내훈, 서진희, 한지호, 고연호, 문정선, 한성숙, 이숙자, 조환기 후보 등 10명이에요. 모두 <strong>민생당</strong> 소속이네요.<br><br> 당신은 진보도 보수도 아닌 성향, 비례후보 10명 이상이고 코로나 긴급지원금 1억 원씩 주는 건 불가능하며 코로나 시국에 자영업자부터 지원해야 한다는 30대, 40대, 50대 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/3-10-01b0120b1000454f891830abc2a5f913'>민생당 정책보기</a>"
},
{
  //218
  title: "노력하는 아재",
  image: './img/results/results-28.png',
  color: '#328BC9',
  survive: 0 ,
...
},
{
  ...
  color: '#658FCB',
  survive: 0 ,
  text: "당신의 이상형은 전 법무부 인권국장이었던 황희석 후보를 포함해 허숙정, 이지윤, 변옥경, 정윤희, 황명필, 조대진, 김정선 후보 등 8명입니다. 모두 <strong>열린민주당</strong> 후보네요.<br><br> 당신은 진보 성향, 국회 개혁이 가장 중요하고 청와대 경력과 방송 경력이 없고 전과가 없는 40~60대 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/12-1557779c7f624ba7bf605645a23c169d'>열린민주당 정책보기</a>"
},
{
  //220
  title: "철수파 신인",
...
},
{
  ...
  color: '#EF7D3F',
  survive: 0 ,
  text: "당신의 이상형은 20대 국회의원 이태규, 권은희 후보를 포함해 김현아, 박삼숙, 안종혁 후보 등 5명이에요. 모두 <strong>국민의당</strong> 소속이네요.<br><br> 당신은 진보도 보수도 아닌 성향, 비례후보 10명 이상이고 코로나 긴급지원금 1억 원씩 주는 건 불가능하며 코로나 시국에 질병관리본부를 질병관리청으로 확대 개편하자는 40대 이상, 의정 경험이 있는 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/10-7c6de5e18f2f4de8aeb1e78c0f9946af'>국민의당 정책보기</a>"
},
{
  //222
  title: "2030 여성 후보",
...
},
{
  //223
  title: "여성과 더불어",
  image: './img/results/results-35.png',
  color: '#328BC9',
  survive: 0 ,
...
},
{
  ...
  color: '#FFE57F',
  survive: 0 ,
  text: "당신의 이상형은 영화감독 겸 장애인 운동가인 장혜영 후보를 포함해 문정은, 정민희, 조성실, 조혜민, 배수정, 김가영 후보 등 <strong>정의당</strong> 후보 7명입니다.<br><br> 당신은 진보 성향, 환경이 가장 중요하고 재생에너지를 우선 추진하는 젊은 2030세대의 여성 후보를 이상형으로 선택했어요.<br><br><a href = 'https://www.notion.so/sbsdata/6-a406405c3a4b4ab287b8cbc24836a689'>정의당 정책보기</a>"
},
{
  //225
  title: "정의당 사람들",
